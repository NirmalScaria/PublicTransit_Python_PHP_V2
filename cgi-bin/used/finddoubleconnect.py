...
#finddoubleconnect(55,666,"09:10:15",18000,120,18000,25)
    ...
    command = """select thefirst.*,thesecond.*
    ...
    order by if(TIME_TO_SEC(thesecond.reachtime)-TIME_TO_SEC('"""+starttime+"""')>0,           /*To get relative time between specified start and reach*/
            TIME_TO_SEC(thesecond.reachtime)-TIME_TO_SEC('"""+starttime+"""'),                       /*if same day, difference between points*/
            TIME_TO_SEC(thesecond.reachtime)+86400-TIME_TO_SEC('"""+starttime+"""'))                 /*if different days, difference between reach+24 and start*/
