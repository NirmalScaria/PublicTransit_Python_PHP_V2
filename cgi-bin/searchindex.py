...
for i in range(0,len(singlepaths)):
    ...
    singlerouteids+=[singlepaths[i][6]]
    #print item
...
doublepaths=[item for item in doublepaths if item[12] not in singlerouteids]
doublepaths=[item for item in doublepaths if item[6] not in singlerouteids]
...
for i in range(0,len(masterres)):
    ...
    if(masterres[i][2]==2):
        ...
        objres={
            ...
            "routeid":[str(masterres[i][6]),str(masterres[i][12])]
        }
